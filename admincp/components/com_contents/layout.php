<?php
	...
	if(isset($_POST["cmdsave"])){
		...
		$obj->CreateDate = date("Y-m-d",$joindate);
		}
		...
		if(isset($_POST["txtmodify"])) {
			...
			$obj->ModifyDate = date("Y-m-d",$joindate2);
		}
		if(isset($_POST["txtauthor"]))  $obj->Author=addslashes($_POST["txtauthor"]);
		$obj->MetaKey=	addslashes($_POST["txtmetakey"]);
		$obj->MetaDesc=	addslashes($_POST["textmetadesc"]);
